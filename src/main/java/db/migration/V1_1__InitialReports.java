...
public class V1_1__InitialReports extends ReportsMigration {
    ...
    public String[] getReportNamesToAdd() {
        return new String[]{"AverageCallDuration", "AverageLessonUsage", "CertificateCourseUsage", "QuizScore", "CertificateLessonUsage", "CertificateRepeatVisit", "ChapterLessonQuizCompletion", "ContentAdmin", "CourseUsage"};
    }
